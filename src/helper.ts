...
import {HolderSentienceOne, HolderSentienceTwo, HolderSentienceThree, HolderSentienceFour, HolderSentienceFive} from "../generated/schema"
...
export function loadOrCreateHolderOne (address: Address): HolderSentienceOne{
    ...
    return holderEntity as HolderSentienceOne;
}
...
export function loadOrCreateHolderTwo (address: Address): HolderSentienceTwo{
    ...
    return holderEntity as HolderSentienceTwo;
}

export function loadOrCreateHolderThree (address: Address): HolderSentienceThree{
    ...
    return holderEntity as HolderSentienceThree;
}
...
export function loadOrCreateHolderFour (address: Address): HolderSentienceFour{
    ...
    return holderEntity as HolderSentienceFour;
}
...
export function loadOrCreateHolderFive (address: Address): HolderSentienceFive{
    ...
    return holderEntity as HolderSentienceFive;
}