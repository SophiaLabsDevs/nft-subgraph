import { Transfer as TransferEvent } from "../generated/SentienceModule4/SentienceModule4";
import { SentienceModule4Transfer as Transfer } from "../generated/schema";
import { loadOrCreateHolderFour } from "./helper";
import { BigInt } from "@graphprotocol/graph-ts";

export function handleTransferFour(event: TransferEvent): void {
  ...
  let recipient = loadOrCreateHolderFour(event.params.to);
  let sender = loadOrCreateHolderFour(event.params.from);
