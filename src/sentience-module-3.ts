import { Transfer as TransferEvent } from "../generated/SentienceModule3/SentienceModule3";
import { SentienceModule3Transfer as Transfer } from "../generated/schema";
import { loadOrCreateHolderThree } from "./helper";
import { BigInt } from "@graphprotocol/graph-ts";

export function handleTransferThree(event: TransferEvent): void {
  ...
  let recipient = loadOrCreateHolderThree(event.params.to);
  let sender = loadOrCreateHolderThree(event.params.from);
